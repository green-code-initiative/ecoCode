...
- [#230](https://github.com/green-code-initiative/ecoCode/pull/230) Deprecate rule EC63 for Java because there are already 3 native Sonarqube rules that cover the same use cases
